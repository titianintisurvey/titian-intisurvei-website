  ...
  return (
    <html lang="id">
      ...
      <body className="bg-slate-50">
        ...
        {/* Navbar Melayang dengan Posisi Ditarik Ke Atas (mt-5) */}
        <header className="absolute w-full z-40 text-white mt-5 bg-gradient-to-b from-[#0b132b]/95 via-[#0b132b]/60 to-transparent pt-2 pb-6 border-none">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            
            <div className="flex justify-between items-center py-1">
              
              {/* Logo & Brand Tampil Penuh Tanpa Bulatan Putih */}
              <Link href="/" className="flex flex-col items-center hover:scale-105 transition-transform duration-300">
                <Image
                  ...
                  width={75} 
                  height={75} 
                  className="drop-shadow-[0_10px_15px_rgba(0,0,0,0.6)] object-contain"
                  priority
                />
                <strong className="text-lg md:text-xl tracking-tight font-extrabold drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] text-center text-white mt-1">
                  {company.name}
                </strong>
              </Link>

              {/* Menu Tengah */}
              <nav className="hidden md:flex space-x-8 font-medium drop-shadow-md items-center">
